...
<div class="page-header">
    <div>
        <h1 class="page-title">Add New Service <small>Create a bookable service</small></h1>
    </div>
...
<div class="row justify-content-center">
    <div class="col-lg-7">
        <div class="content-card">
            <div class="card-header"><i class="bi bi-plus-circle me-2"></i>Service Details</div>
            <div class="card-body">
                <form method="POST" action="{{ route('services.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                               value="{{ old('title') }}" placeholder="e.g. General Consultation" required>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" name="duration" class="form-control @error('duration') is-invalid @enderror"
                                   value="{{ old('duration', 30) }}" min="5" max="480" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="price" step="0.01" class="form-control @error('price') is-invalid @enderror"
                                   value="{{ old('price', 500) }}" min="0" required>
